...
public class LoginController {
    ...
    @FXML private TextField passwordTextField; // dùng khi show password
     ...
     *
     * NOTE: currently compares plain-text password. For production use hashed passwords.
     */
        ...
        try (Connection conn = DatabaseUtil.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    // plain-text compare (as your current DB uses). Replace with hash check if needed.
                    boolean passwordMatch = storedPassword != null && storedPassword.equals(password);

                    if (passwordMatch) {
                        // build User matching your model: User(String userId, String fullName, String department, String username, String password)
